			   // // Given a Sum find the triplet pair in that sums to given value //


/*
   Algorithm
   
      here for each element we applt two pointer algorithm to remainig array after sorting the whole array 
      ...
      Algorithm : 
		...
		4. Else, if the sum of elements at two-pointer is equal to given sum then print the triplet and break.
